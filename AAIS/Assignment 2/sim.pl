...
tracefile('C:/Users/adamze/HUD MSc Repo/HUD MSc in AI/AAIS/Assignment 2/trace0-5.txt') :-computer(windows).
...
% Test from week 9 exercise

my_test :- 
        initial(I),
            compile(I),
  % now the scenario file I has been read in, we can get at its components:
