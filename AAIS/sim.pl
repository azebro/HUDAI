...
initial('c:/Users/lapadmin/Desktop/coursesim/initial_state.pl') :- computer(windows).

% Domain Model File
domainmodel('../Users/lee/Desktop/coursesim/domain_model.pl') :- computer(mac).
domainmodel('c:/Users/lapadmin/Desktop/coursesim/domain_model.pl') :- computer(windows).

% WHERE to put log information 
tracefile('../Users/lee/Desktop/coursesim/trace.txt') :- computer(mac).
tracefile('c:/Users/lapadmin/Desktop/coursesim/trace.txt') :-computer(windows).
